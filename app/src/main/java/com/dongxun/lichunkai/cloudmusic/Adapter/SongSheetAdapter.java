...
public class SongSheetAdapter extends RecyclerView.Adapter<SongSheetAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder( View itemView) {
            super(itemView);
            textView_order = (TextView)itemView.findViewById(R.id.textView_order);
    ...
    public SongSheetAdapter(ArrayList<Song> searchHistoryList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_songsheet,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        holder.textView_order.setText(order+"");order++;
